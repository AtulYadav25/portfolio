        ...
        <TooltipProvider>
            <Tooltip delayDuration={200}>
                <TooltipTrigger asChild>
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-800/50 border border-dashed border-zinc-600 rounded-md text-sm text-zinc-300 hover:border-zinc-500 hover:bg-zinc-800 transition-all cursor-default !bg-gray-800">
